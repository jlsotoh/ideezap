...
public class MainActivity extends AppCompatActivity  {
            ...
            public void onReceive(Context context, Intent zIntent) {
                ...
                switch (zIntent.getAction()) {
                    ...
                    case ZapparEmbed.ACTION_HOST_MESSAGE:
                        String ActionHost = zIntent.getStringExtra(ZapparEmbed.EXTRA_HOST_MESSAGE);
                        Log.d("CustomAnalytics", "Zappar extra host mesage: " + ActionHost);
                        try {
                            cerrarZappar(ActionHost);
    ...
    private void cerrarZappar(String actionHost) throws JSONException {
        JSONObject jRes = new JSONObject(actionHost);
        if (jRes.get("message").equals("cerrarSDK")){
           // int idZappar = getIntent().getIdentifier().;
            //finishActivity(idZappar);
    ...
    public void botonDeep(){
        ...
        try {
            ...
            //zid de prueba propio(blue clean
            //zid = "z/Vh5o1c";

            //zid embed (blue embed)
            //zid = "z/l-gn1c";
            String url = zid + "?data="+obj.toString();


            if (isCompatible) {
                iZappar = new Intent(this, ZapparEmbed.getZapcodeClassForIntent());
                iZappar.putExtra(ZapparEmbed.EXTRA_LAUNCH_DEEP_LINK, url);
            ...
            Log.e("MainActivity", "Could not parse malformed JSON: \"" + otroJson + "\"");
        }
